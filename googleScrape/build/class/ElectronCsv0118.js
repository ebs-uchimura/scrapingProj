...
const csv_parse_1 = require("csv-parse"); // csv parser
const csv_stringify_1 = require("csv-stringify"); // csv 
            ...
            return new Promise((resolve, reject) => __awaiter(this, void 0, void 0, function* () {
                try {
                    ...
                    if (filenames.length) {
                        ...
                        // csv parse
                        const tmpRecords = (0, csv_parse_1.parse)(str, {
        ...
        this.makeCsvData = (arr, columns, filename) => __awaiter(this, void 0, void 0, function* () {
            return new Promise((resolve, reject) => __awaiter(this, void 0, void 0, function* () {
                try {
                    ...
                    // csvdata
                    const csvData = (0, csv_stringify_1.stringify)(arr, { header: true, columns: columns });
                    // write to csv file
                    yield writeFile(filename, iconv_lite_1.default.encode(csvData, 'shift_jis'));
                    // complete
                    resolve();
                }
                catch (e) {
