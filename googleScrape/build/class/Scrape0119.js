...
const PROXY_SETTING = '--proxy-server=http://164.70.67.78:8080'; // proxy
// define modules
    ...
    init() {
        return new Promise((resolve, reject) => __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                yield Scrape.page.evaluateOnNewDocument(() => {
                    Object.defineProperty(navigator, 'webdriver', { get: () => false });
                });
                // mimic agent
                yield Scrape.page.setUserAgent(yield Scrape.generateRandomUA());
                // resolved
                resolve();
            }
            catch (e) {
    ...
    static generateRandomUA() {
        return new Promise((resolve, reject) => __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                resolve(userAgents[randomUAIndex]);
            }
            catch (e) {
                // if type is error
                if (e instanceof Error) {
