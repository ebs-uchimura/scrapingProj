...
export namespace mySelector {
  ...
  export const tabelogMainImage1Selector: string =
    "#column-main > div.rstdtl-top-postphoto > ul > li:nth-child(1) > p > a > img";
  // tabelog area selector
  export const tabelogMainImage2Selector: string =
    "#column-main > div.rstdtl-top-postphoto > ul > li:nth-child(2) > p > a > img";
  // tabelog mainshopname selector
  export const tabelogMainImage3Selector: string =
    "#column-main > div.rstdtl-top-postphoto > ul > li:nth-child(3) > p > a > img";
  // tabelog address selector
  export const tabelogMainImage4Selector: string =
    "#column-main > div.rstdtl-top-postphoto > ul > li:nth-child(4) > p > a > img";
  // tabelog access selector
  export const tabelogMainImage5Selector: string =
    "#column-main > div.rstdtl-top-postphoto > ul > li:nth-child(5) > p > a > img";
  // Tabelog genre selector
