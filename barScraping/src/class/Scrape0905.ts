...
// constants
const USER_ROOT_PATH: string =
  process.env[process.platform == "win32" ? "USERPROFILE" : "HOME"] ?? ""; // user path
const CHROME_EXEC_PATH1: string =
  "C:\\Program Files (x86)\\Google\\Chrome\\Application\\chrome.exe"; // chrome.exe path1
const CHROME_EXEC_PATH2: string =
  "C:\\Program Files\\Google\\Chrome\\Application\\chrome.exe"; // chrome.exe path2
const CHROME_EXEC_PATH3: string =
  "\\AppData\\Local\\Google\\Chrome\\Application\\chrome.exe"; // chrome.exe path3
