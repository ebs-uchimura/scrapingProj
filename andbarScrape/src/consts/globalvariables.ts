...
export namespace myColumn {
  export const columns: string[] = [
    ...
    'address', // address
    'system', // system
    'businesstime1', // businesstime1
    'businesstime2', // businesstime2
    'businesstime3', // businesstime3
    'businesstime4', // businesstime4
    'businesstime5', // businesstime5
    'businesstime6', // businesstime6
    'businesstime7', // businesstime7
    'businesstime8', // businesstime8
    'info2', // info2
    'info3', // info3
    'info4', // info4
    'info5', // info5
  ...
  export const urlColumns: string[] = ['url'];
}
